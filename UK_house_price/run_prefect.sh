...
prefect config set PREFECT_ORION_UI_API_URL="http://3.11.9.244:4200/api"

prefect config set PREFECT_API_URL="http://3.11.9.244:4200/api"
...
http://ec2-3-11-9-244.eu-west-2.compute.amazonaws.com:5000
