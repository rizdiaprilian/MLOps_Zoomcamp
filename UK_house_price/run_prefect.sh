...
prefect config set PREFECT_ORION_UI_API_URL="http://18.170.70.140:4200/api"

prefect config set PREFECT_API_URL="http://18.170.70.140:4200/api"
...
export MLFLOW_TRACKING_URI="http://ec2-18-170-70-140.eu-west-2.compute.amazonaws.com:5000"
...
http://ec2-18-170-70-140.eu-west-2.compute.amazonaws.com:5000